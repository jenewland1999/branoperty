...
import branoperty.util.DataManager;
...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        primaryStage.setTitle("Branoperty - Login");
    ...
    public static String getAdminFile() {
        return Objects.requireNonNull(App.class.getClassLoader().getResource(ADMIN_FILENAME)).getFile();
    }
