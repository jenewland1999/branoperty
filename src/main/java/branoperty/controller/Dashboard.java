...
import branoperty.controller.branch.CreateBranch;
import branoperty.controller.branch.UpdateBranch;
import branoperty.controller.branch.ViewBranch;
import branoperty.controller.property.CreateProperty;
import branoperty.controller.property.UpdateProperty;
import branoperty.controller.property.ViewProperty;
import branoperty.model.Branch;
import branoperty.model.IModel;
import branoperty.model.Session;
...
public class Dashboard {
    ...
    public void createProperty() throws IOException {
        FXMLLoader loader = openGui(
                "./view/property/createProperty.fxml",
                String.format("Branoperty - %s Dashboard - Create Property",
                        getSession().isAdmin() ? "Admin" : "Secretary"
                ), 800, 600, true);

        CreateProperty controller = loader.getController();
    ...
    public void viewProperty() throws IOException {
        ...
        FXMLLoader loader = openGui(
                "./view/property/viewProperty.fxml",
                String.format("Branoperty - %s Dashboard - View Property",
                        getSession().isAdmin() ? "Admin" : "Secretary"),
                800,
                600,
                true
        ...
        ViewProperty controller = loader.getController();
        controller.setDashboardController(this);
    ...
    public void updateProperty() throws IOException {
        ...
        FXMLLoader loader = openGui(
                "./view/property/updateProperty.fxml",
                String.format("Branoperty - %s Dashboard - Update Property",
                        getSession().isAdmin() ? "Admin" : "Secretary"
                ), 800, 600, true);

        UpdateProperty controller = loader.getController();
        controller.setDashboardController(this);
        controller.setSession(session);
        controller.setProperty(tableViewProperty.getSelectionModel().getSelectedItem());
        controller.populateFields();
    ...
    public void deleteProperty() {
        ...
        alert.setTitle("Branoperty - Confirm Action");
    ...
    public void viewBranch() throws IOException {
        ...
        FXMLLoader loader = openGui(
                "./view/branch/viewBranch.fxml",
                "Branoperty - Admin Dashboard - View Branch",
                400,
                600,
                true
        );

        ViewBranch controller = loader.getController();
        controller.setDashboardController(this);
    ...
    public void createBranch() throws IOException {
        FXMLLoader loader = openGui(
                "./view/branch/createBranch.fxml",
                "Branoperty - Admin Dashboard - Create Branch",
                400,
                600,
                true
        );

        ((CreateBranch) loader.getController()).setDashboardController(this);
    }
    ...
    public void updateBranch() throws IOException {
        ...
        FXMLLoader loader = openGui(
                "./view/branch/updateBranch.fxml",
                "Branoperty - Admin Dashboard - Update Branch",
                400,
                600,
                true
        );

        UpdateBranch controller = loader.getController();
